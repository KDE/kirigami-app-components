...
public:
    IconGroup(QmlActionData *parent = nullptr);
    ~IconGroup();
...
class QmlActionData : public ActionData, public QQmlParserStatus
{
    Q_OBJECT
...
public:
    explicit QmlActionData(QObject *parent = nullptr);
    ~QmlActionData() override;
